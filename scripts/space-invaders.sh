...
aliens1=( '\033[1;32m|0|\033[0m' '\033[1;34m\-/\033[0m' '\033[1;35m:x:\033[0m' '\033[1;38m:#:\033[0m' '\033[1;33m!|!\033[0m' '\033[1;39m:-:\033[0m' ) 

aliens2=( '\033[1;32m:0:\033[0m' '\033[1;34m/-\\\033[0m' '\033[1;35m-x-\033[0m' '\033[1;38m-#-\033[0m' '\033[1;33m:|:\033[0m' '\033[1;39m-:-\033[0m' ) 
score=0 
...
if [ $aliensonrow -eq 0 ];then
	# Nothing to do here. In particuluar, do not detect failure.
...
if (( $offset % 2 == 0 ));then
	thisalien=${aliens1[$alientype]};else
	thisalien=${aliens2[$alientype]};fi
...
aliensleft=`echo ${row0[@]} ${row1[@]} ${row2[@]} ${row3[@]} ${row4[@]} ${row5[@]} | tr ' ' '+' | bc`
